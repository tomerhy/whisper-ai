...
// Uses the user's Claude session - no API key required!
...
(function() {
  ...
  // Get Claude textarea/contenteditable
  function getTextarea() {
    return document.querySelector('[contenteditable="true"].ProseMirror') ||
           document.querySelector('div[contenteditable="true"][data-placeholder]') ||
           document.querySelector('div.ProseMirror[contenteditable="true"]') ||
           document.querySelector('[data-placeholder="Reply to Claude…"]') ||
  ...
  function setTextareaContent(textarea, text) {
    ...
    // Claude uses ProseMirror, need to handle specially
    textarea.innerHTML = `<p>${escapeHtml(text)}</p>`;
    textarea.dispatchEvent(new InputEvent('input', { bubbles: true }));
    
    // Also try focusing and triggering events
    textarea.focus();
  }
