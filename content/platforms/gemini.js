// ===== Whisper AI - Gemini Content Script =====
// Uses the user's Gemini session - no API key required!
...
(function() {
  ...
  function init() {
    console.log('Whisper AI initialized for Gemini');
    loadSettings();
  ...
  // Get Gemini textarea/contenteditable
  function getTextarea() {
    return document.querySelector('.ql-editor[contenteditable="true"]') ||
           ...
           document.querySelector('.text-input-field_input-box') ||
