...
(function() {
  ...
  function showQuickEnhanceButton(textarea) {
    ...
    // Position button above the textarea
  ...
  // This provides instant enhancement without needing to send a message
  async function simulateEnhancement(prompt, profile) {
    // Local enhancement logic - makes prompt better without external API
    const enhancements = [];
    ...
    // Add structure request if not present
    ...
    // Add specificity request if prompt is short
